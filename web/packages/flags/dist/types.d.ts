...
export type FlagStreamEvent = {
    ...
    event: 'flag.archived';
    data: FlagArchivedData;
} | {
    event: 'flag.restored';
    data: FlagRestoredData;
} | {
    event: 'killswitch.activated';
    data: KillSwitchActivatedData;
} | {
    event: 'killswitch.deactivated';
    data: KillSwitchDeactivatedData;
} | {
    event: 'heartbeat';
    data: HeartbeatData;
};
 ...
 */
export declare function createEvaluationContext(environment: string, options?: Partial<Omit<EvaluationContext, 'environment'>>): EvaluationContext;
/**
 * Get boolean value from VariantValue.
 */
export declare function getVariantBool(value: VariantValue, defaultValue: boolean): boolean;
/**
 * Get string value from VariantValue.
 */
export declare function getVariantString(value: VariantValue, defaultValue: string): string;
/**
 * Get JSON value from VariantValue.
 */
export declare function getVariantJson<T>(value: VariantValue, defaultValue: T): T;
