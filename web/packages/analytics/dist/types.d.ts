 ...
 */
export type PersistenceMode = 'localStorage+cookie' | 'localStorage' | 'cookie' | 'memory';
/**
 ...
 */
export declare const DEFAULT_AUTOCAPTURE_CONFIG: AutocaptureConfig;
/**
 * Cookie settings.
 */
 ...
 */
export declare const LOCALSTORAGE_KEY = "loom_analytics_distinct_id";
/**
 * SDK version.
 */
 ...
 * SDK name.
 */
export declare const SDK_NAME = "@loom/analytics";
